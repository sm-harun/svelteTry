...
<script lang="ts">
    ...
    import { addTask, type Task } from '../taskStore';

    export let changeAddMenuState: (status: boolean) => void;
    ...
    function handleEvents() {
        ...
        let newTask: Task = { taskName: titleValue, description: descriptionValue, date: dateValue, time: timeValue };
...
<div class='form-container' in:fly={{ y: 100 }} out:fly={{ y: 100 }}>
    ...
    <button class='svg-container' on:click={() => { changeAddMenuState(false) }}>
